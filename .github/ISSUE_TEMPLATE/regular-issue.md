...
- [ ] Check that you are up-to-date with the master branch of Textformer. You can update with:
pip install git+git://github.com/gugarosa/textformer.git --upgrade --no-deps

- [ ] Check that you have read all of our [README](https://github.com/gugarosa/textformer/blob/master/README.md).
